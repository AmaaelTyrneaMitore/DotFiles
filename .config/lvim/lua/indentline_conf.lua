...
vim.cmd [[highlight IndentBlanklineIndent1 guifg=#f8f8f2 gui=nocombine]]
...
vim.cmd [[highlight IndentBlanklineIndent4 guifg=#50fa7b gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndent5 guifg=#bd93f9 gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndent6 guifg=#ffb86c gui=nocombine]]
vim.cmd [[highlight IndentBlanklineContextChar guifg=#f1fa8c gui=nocombine]]
vim.cmd [[highlight NvimTreeIndentMarker guifg=#ff79c6 gui=nocombine]]
vim.opt.list = true

local function setup_indentline()
